...
> Services 当前治理：Core Sprint 13/14 既有事实继续有效；Services 受控并行 PR 阶段由 CODEOWNERS 共同审查、API split、Services boundary gate 和 make validate-architecture 约束，当前执行入口仍是 repo/CURRENT-SPRINT.md。
