...
> Sprint 14 分支执行：`feature/sprint14-core-resilience-semantics` 已完成 R-P0-0 gateway shared store 前置批次与 R-P0-1 gateway rate limit；这些批次仅为 local/logic verified，不声明 production ready。
