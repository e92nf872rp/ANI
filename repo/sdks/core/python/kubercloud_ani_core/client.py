...
PATHS = [
    ...
    "GET /gpu-inventory",
    "GET /gpu-inventory/events",
    "POST /gpu-inventory/gpu-partitions",
...
SCHEMAS = [
    ...
    "ConsoleInferenceServiceOverview",
    "ConsoleInferenceServiceStatusDistribution",
    "ConsoleInstanceOverview",
    "ConsoleInstanceStateDistribution",
    "ConsoleKnowledgeBaseOverview",
    "ConsoleKnowledgeBaseStatusDistribution",
    "ConsoleModelOverview",
    "ConsoleModelStatusDistribution",
    ...
    "GPUDeviceEvent",
    "GPUDeviceEventListResponse",
    "GPUDeviceStatusUpdateRequest",
    "GPUInventoryListResponse",
    "GPUInventoryRecord",
    "GPUOccupancyStats",
    "GPUPartitionCreateRequest",
    "GPUPartitionTaskAccepted",
    "GPUSchedulingQueue",
