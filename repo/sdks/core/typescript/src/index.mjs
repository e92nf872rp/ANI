...
export const paths = [
  ...
  "GET /gpu-inventory/{device_id}/slices",
  "POST /gpu-inventory/{device_id}/slices",
  ...
  "DELETE /gpu-slices/{slice_id}",
  "PATCH /gpu-slices/{slice_id}",
  "DELETE /gpu-slices/{slice_id}/reservation",
  "GET /gpu-specs",
  "POST /gpu-specs",
