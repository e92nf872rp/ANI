...
export const serverURL = "http://127.0.0.1:4010/api/v1";
...
export const paths = [
  ...
  "GET /instances/{instance_id}/console/{session_id}",
  "GET /instances/{instance_id}/events",
  "POST /instances/{instance_id}/exec",
  "GET /instances/{instance_id}/exec/{session_id}",
  ...
  "PATCH /networks/security-groups/{security_group_id}",
