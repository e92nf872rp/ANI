...
func RegisterWithTargetIAM(h *server.Hertz, store GatewayStore, targetClient targetiam.Client) error {
	if store == nil {
...
func registerChainWithTarget(
	h *server.Hertz, store GatewayStore, client AuthClient, targetClient targetiam.Client,
