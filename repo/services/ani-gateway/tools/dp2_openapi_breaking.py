...
def verify_source_identity(commit: str, expected_tree: str) -> None:
    verify_git_tree(ROOT.parent, commit, expected_tree, DiffError, "fixed source")
...
def main() -> int:
    ...
    try:
        ...
        source_text = read_git_object_text(ROOT.parent, SOURCE_COMMIT, SOURCE_PATH, DiffError)
