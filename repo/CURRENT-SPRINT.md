...
| INSTANCE-SANDBOX-CONTRACT-A | 契约与生成物完成，等待个人仓库 CI/契约评审 | 新增 Sandbox token、预览端口、文件、checkpoint 和异步 code-run 共 11 个操作；固定租户/kind、幂等、任务轮询和敏感输出审计边界；不含 handler/port/adapter/Console |
